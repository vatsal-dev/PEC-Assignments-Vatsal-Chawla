...
Enter the name of the Student: Nikita Sharma
Enter the Student Id: 21103002
Enter the gender of the Student(F, M, U): F
Enter the Student's course name: Introduction to Computing
Enter the Student's CGPA: 10
['Name', 'SID', 'Gender', 'Course name', 'CGPA']

 The list of the Student information:
  ['Nikita Sharma', 21103002, 'F', 'Introduction to Computing', 10.0]


# Question 4 : Make a list to enter marks of 5 students into a list and display them in a sorted manner.

Enter the marks of the Student 1: 96
Enter the marks of the Student 2: 89
Enter the marks of the Student 3: 93
Enter the marks of the Student 4: 100
Enter the marks of the Student 5: 85
